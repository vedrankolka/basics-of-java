...
public class ArrayIndexedCollectionTest {
	...
	public static ArrayIndexedCollection<Object> testCollection;
	...
	public void constructorWithValidInitialCapacityTest() {
		ArrayIndexedCollection<Object> collection = new ArrayIndexedCollection<>(1);
	...
	public void constructorWithValidOtherCollectionAndInitialCapacityTest1() {
		ArrayIndexedCollection<Object> collection = new ArrayIndexedCollection<>(testCollection, 9);
	...
	public void constructorWithValidOtherCollectionAndInitialCapacityTest2() {
		ArrayIndexedCollection<Object> collection = new ArrayIndexedCollection<>(testCollection, 3);
		assertEquals(testCollection.size(), collection.size());
	...
	public void constructorWithValidOtherCollectionTest() {
		ArrayIndexedCollection<Object> collection = new ArrayIndexedCollection<>(testCollection);
		assertEquals(testCollection.size(), collection.size());
		assertEquals(16, collection.getCapacity());
		assertTrue(collection.contains("Leonarda"));
		assertFalse(collection.contains(null));
	...
	public void addNonNullObjectTest() {
		ArrayIndexedCollection<Object> collection = new ArrayIndexedCollection<>(testCollection, 4);
