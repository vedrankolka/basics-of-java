...
public class Demo5 {
	...
	public static void main(String[] args) {
		...
		col1.get(0);
		col2.get(0);
//		col3.get(0); // neće se prevesti! Razumijete li zašto? Razumijem!
//		col4.get(0); // neće se prevesti! Razumijete li zašto? Razumijem!
		col1.forEach(System.out::println); // Ivana
		col2.forEach(System.out::println); // Jasna
		col3.forEach(System.out::println); // Ivana jel ti Jasno?
		col4.forEach(System.out::println); // Jasno
