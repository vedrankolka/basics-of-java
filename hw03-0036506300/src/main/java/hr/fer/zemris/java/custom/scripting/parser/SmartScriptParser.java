...
public class SmartScriptParser {
		...
		while(true) {
			...
			if(token.getType()==TokenType.TAG_BEGINNING_SEQUENCE) {
				...
				try {
					...
					//if the tag was opened but there was not a recognisable tag name, throw hands
	 ...
	 */
	private static String reconstructEchoTag(EchoNode node) {
	 ...
	 */
	private static String reconstructForLoopTag(ForLoopNode node) {
